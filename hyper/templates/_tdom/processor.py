...
def _node_from_value(value: object) -> Node:
    ...
    match value:
        ...
        case HasHTMLDunder():
            ...
            return Text(Markup(value.__html__()))  # nosec B704 - object has __html__ protocol
...
def _is_wildcard(pattern: object) -> bool:
    ...
    return type_name == "object" and not isinstance(
        pattern, (str, int, float, bool, type(None))
    )
